  ...
  return (
    <div className="min-h-screen">
      ...
      <main id="main-content">
        ...
        <section className="py-16 bg-white" aria-label="Project photo gallery">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <DialogContent className="max-w-6xl p-0 bg-black/95 border-none">
            <div className="relative">
              ...
              <img 
                ...
                alt={selectedImageIndex !== null ? projectDescriptions[selectedImageIndex] : "Project detail"} 
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="text-xl text-gray-600 mb-12 font-poppins">
                We're currently updating our project portfolio. Check back soon to see more of our construction and remodeling projects throughout Atlanta.
              </p>
              <Link to="/contact">
                <button 
