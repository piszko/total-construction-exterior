...
const About = () => {
  return (
    <div className="min-h-screen">
      <SEOHead
        title="About Us | Total Construction & Remodeling Atlanta"
        description="Learn about Total Construction & Remodeling, serving Atlanta since 1990 with 35+ years of quality construction, roofing, and remodeling experience."
        canonicalPath="/about"
      />
      <Header />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              <h1 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6 font-poppins">
                About Total Construction &amp; Remodeling
              </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="flex items-start">
                <img 
                  ...
                  alt="Completed residential construction project by Total Construction & Remodeling in Atlanta"
