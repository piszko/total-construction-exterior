...
const Reviews = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col">
      <SEOHead
        title="Customer Reviews | Total Construction Atlanta"
        description="Read reviews from satisfied customers of Total Construction & Remodeling in Atlanta. See why homeowners trust us for construction and remodeling."
      ...
      <main id="main-content" className="flex-1 bg-white">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto font-poppins mb-8">
                See what our satisfied customers have to say about our construction and remodeling work in Atlanta.
              </p>
              <a href="/contact#forms" className="inline-block">
                <button
                  ...
                  style={{ width: "220px", height: "62px", borderRadius: "27px" }}
                >
                  Leave a Review
                </button>
              </a>
        ...
        {/* Reviews Grid */}
        <section className="pt-8 pb-16 bg-gray-50" aria-label="Customer reviews">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="mb-4">
                      ...
                      {review.text.length > 150 && (
                        <button
                          ...
                          className="text-logo-red hover:bg-logo-red hover:text-white border border-logo-red font-poppins text-sm font-medium mt-2 flex items-center gap-1 transition-all rounded-full px-4 py-1.5 focus:outline-none focus:ring-2 focus:ring-logo-red"
